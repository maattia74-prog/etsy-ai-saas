import { pgTable, uuid, text, timestamp, real, integer, jsonb, boolean, vector, index, uniqueIndex } from 'drizzle-orm/pg-core';
...
export const embeddings = pgTable('embeddings', {
  ...
  embeddingIdx: index('embeddings_embedding_idx').using('ivfflat', table.embedding),
}));
